...
import dsweb.dao.ProdutoJdbcDao;
...
public class ProdutoController {
	...
	public String pesquisa(Model model,@RequestParam("procurar") String procurar){
		
		model.addAttribute("produtos", produtoDao.pesquisa(procurar));
		return"lista_produtos";
	}
